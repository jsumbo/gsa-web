...
async function getPlayers(): Promise<Player[]> {
  try {
    ...
    return all.filter((p) => p.team === 'youth-15')
  } catch (e) {
    console.error('Failed to load youth-15 players:', e)
    return []
  }
}

export const metadata = {
  title: 'Youth-15 | Gayduo Sports Academy',
  description: 'Meet the Gayduo Sports Academy Youth-15 squad.',
}

export default async function Youth15Page() {
      ...
      <main className="pt-16 lg:pt-[70px]">
        ...
        <div className="bg-[#01255f] py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-10">
            <span className="label-light">Youth Development</span>
            <h1
            ...
            <p className="text-white/60 text-sm sm:text-base max-w-lg">
              The next generation of talent being developed through our youth programme.
            </p>
